...
/**
 * 帧动画 待机动 攻击算法 游戏整体逻辑思路 渲染 NPC的ai处理
 * 
 * 
*/	
...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	//实现目录的载入，这样当后面使用资源的时候就不需要加上前面的路径
	FileUtils::getInstance()->addSearchPath("rocker");
	FileUtils::getInstance()->addSearchPath("Export");
	FileUtils::getInstance()->addSearchPath("jsonFile");
